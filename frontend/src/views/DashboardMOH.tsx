  ...
  return (
    <div>
      ...
      <div className="mt-5 px-4">
        {value === 'mother' && <CustomPaginationActionsTable />} {/* Mother List */}
        {value === 'phm' && <CustomPaginationActionsTable />}    {/* PHM List */}
        {value === 'pending' && <CustomPaginationActionsTable />} {/* Pending List */}
      </div>
    </div>
  );
};
