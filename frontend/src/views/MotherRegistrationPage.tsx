  ...
  return (
    <div className="flex justify-center items-center h-screen bg-white">
      ...
      >
        ...
        <div className="w-full">
          <label htmlFor="phone_1" className="block text-sm font-medium text-gray-700 mb-1">Mobile Phone Number</label>
          <input
            type="text"
            name="phone_1"
            id="phone_1"
            className={`block w-full p-2 border rounded-lg shadow-md ${
              formik.touched.phone_1 && formik.errors.phone_1 ? "border-red-500" : "border-gray-300"
            }`}
          ...
          {formik.touched.phone_1 && formik.errors.phone_1 && (
            <div className="text-red-500 text-sm mt-1">{formik.errors.phone_1}</div>
          )}
        </div>
        ...
        <div className="w-full">
          ...
          <input
            ...
            id="delivery_date"
            className={`block w-full p-2 border rounded-lg shadow-md ${
              formik.touched.delivery_date && formik.errors.delivery_date ? "border-red-500" : "border-gray-300"
            }`}
          ...
          {formik.touched.delivery_date && formik.errors.delivery_date && (
            <div className="text-red-500 text-sm mt-1">{formik.errors.delivery_date}</div>
          )}
        </div>
