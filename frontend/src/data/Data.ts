    ...
    content: [
      {
        ...
        content: {
          para1:
            "Breastfeeding is a natural way to nourish your baby with the perfect blend of vitamins, antibodies, and nutrients for optimal growth and development. It offers numerous benefits for both mother and baby. For babies, breast milk provides essential immune system support, reduces the risk of infections like earaches and respiratory illnesses, and promotes healthy weight gain. Breastfeeding also fosters emotional bonding between mother and baby through skin-to-skin contact and the release of oxytocin, a hormone that promotes feelings of love and attachment. Mothers who breastfeed benefit from reduced risks of breast and ovarian cancers, postpartum depression, and type 2 diabetes. Additionally, breastfeeding can help your uterus shrink back to its pre-pregnancy size and may even lead to faster weight loss.",
          para2:
            "Breastfeeding is a vital aspect of early motherhood that provides essential nutrients and antibodies to newborns, fostering their growth and immune system development. It also strengthens the emotional bond between mother and baby. However, the journey of breastfeeding can be challenging, particularly in the initial weeks. Many new mothers face difficulties such as latching issues, nipple pain, and concerns about milk supply.",
          para3:
            "It's crucial to understand the basics, including how to achieve a proper latch, recognizing your baby's hunger cues, and ensuring a comfortable breastfeeding position. Seeking support from lactation consultants and joining breastfeeding support groups can be incredibly beneficial. These resources offer guidance and reassurance, helping you navigate and overcome common challenges.",
        },
      },
      {
        id: 2,
