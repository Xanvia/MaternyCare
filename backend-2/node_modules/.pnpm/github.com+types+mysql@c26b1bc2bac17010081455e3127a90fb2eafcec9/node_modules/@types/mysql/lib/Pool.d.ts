...
import Query = require('.pnpm/github.com+types+mysql@c26b1bc2bac17010081455e3127a90fb2eafcec9/node_modules/@types/mysql/lib/protocol/sequences/Query');
import {OkPacket, RowDataPacket, FieldPacket, ResultSetHeader} from '.pnpm/github.com+types+mysql@c26b1bc2bac17010081455e3127a90fb2eafcec9/node_modules/@types/mysql/lib/protocol/packets';
import Connection = require('.pnpm/github.com+types+mysql@c26b1bc2bac17010081455e3127a90fb2eafcec9/node_modules/@types/mysql/lib/Connection');
import PoolConnection = require('.pnpm/github.com+types+mysql@c26b1bc2bac17010081455e3127a90fb2eafcec9/node_modules/@types/mysql/lib/PoolConnection');
